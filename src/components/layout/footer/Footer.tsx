  ...
  return (
    <footer id="contact" className="site-footer relative mt-20 sm:mt-32 lg:mt-36">
      ...
      <div className="footer-top-cta relative overflow-hidden bg-text sm:overflow-visible">
        <Container className="relative pt-8 pb-8 sm:pt-11 sm:pb-10">
          <div className="footer-top-content relative z-10 max-w-full sm:max-w-xl">
      ...
      <div className="footer-image-section relative overflow-hidden bg-text">
        ...
        <Container className="relative flex flex-col gap-3 pt-7 pb-14 sm:pt-8 sm:pb-20">
          <div className="footer-cta-row grid gap-5 md:grid-cols-2 md:items-start">
            <div className="footer-journey-block w-full max-w-[470px] md:ml-8">
              <h3 className="font-serif text-[40px] font-normal leading-[46px] !text-white">
