...
const CoreServices = () => {
    ...
    return (
        <div className="flex items-center justify-center mx-auto w-full mb-50 ">
            <div className="flex flex-col space-y-6 w-[1478px]">
                ...
                <div className="felx flex-col space-y-4">
                    ...
                    <div className="flex justify-between">
                        <h1 className={`items-start justify-start w-1/3 h-full font-lingo text-[${typography.header1.fontSize}px]`}>
                        ...
                        SERVICES_PANELS.map((service, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={`just-between p-6 h-[385px] w-[864px] text-[${colors.red4}] bg-[#f5f3f4] flex flex-col justify-between items-start  absolute  bottom-4 left-16 transition-all  duration-800 ease-out
                                    ...
                                    `}>
                                        ...
                                        <div>
                                            ...
                                            <p className={`text-[${typography.header2.fontSize}px] font-outfit text-[${colors.red4}] `}
                                            >
                                                {service.description}
                                            </p>
                                        </div>
