...
export default function TestimonialsSection() {
  ...
  const slideRefs = useRef<
    Partial<Record<TestimonialId, HTMLElement | null>>
  >({});
  ...
  return (
    <section aria-label="Client testimonials" className="bg-white">
      <div className="mx-auto flex w-full max-w-[var(--feature-section-max-width)] flex-col px-[var(--spacing-container-x-sm)] py-[var(--spacing-section-y-sm)] md:px-[var(--spacing-container-x)] lg:px-[var(--feature-section-padding-x)] lg:py-[var(--spacing-section-y)]">
        <div className="mx-auto flex w-full max-w-[var(--testimonials-section-width)] flex-col gap-[var(--testimonials-outer-gap)]">
          <SectionHeader
          ...
          <div className="flex flex-col gap-4 lg:hidden">
            <div
              ref={mobileScrollRef}
              className="-mx-[var(--spacing-container-x-sm)] flex snap-x snap-mandatory flex-row gap-[var(--testimonials-mobile-carousel-gap)] overflow-x-auto overscroll-x-contain scroll-pl-[var(--testimonials-mobile-scroll-padding)] scroll-pr-[var(--testimonials-mobile-scroll-padding)] px-[var(--testimonials-mobile-scroll-padding)] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
            >
            ...
            <div className="relative isolate flex w-full min-h-[var(--testimonials-frame-height)] flex-col justify-between gap-2 overflow-hidden rounded-[var(--radius-md)] bg-white-2 p-[var(--testimonials-frame-padding)]">
              ...
              <div className="relative z-0 mx-auto flex w-full max-w-[var(--testimonials-content-width)] flex-col items-start gap-32 pl-[var(--testimonials-content-padding-left)]">
                ...
                <div className="flex w-full max-w-[var(--testimonials-attribution-width)] flex-col items-start gap-[var(--testimonials-attribution-gap)]">
                  <p className="font-outfit text-header-3 text-title">
                    {activeTestimonial.name}
                  </p>
                  <p className="font-outfit text-header-3 text-quote-subtext">
