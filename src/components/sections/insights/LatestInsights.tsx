            ...
            <div className="flex flex-col justify-center space-y-6 w-full">
                    ...
                    {INSIGHTS_BLOG_POSTS.map((_, i) => (
                        <button
                            ...
                            className={`h-2 rounded-full transition-all duration-300 ${
                                activeIndex === i ? "w-5 bg-[#E5383B]" : "w-2 bg-gray-300"
                            }`}
                            onClick={() => {
                ...
                >
                    ...
                    <div className="items-center justify-center flex">
                        <img src="src\assets\insights\arrow icon.png" className="w-fit h-fit opacity-100 translate-x-0 md:opacity-0 md:-translate-x-5 md:group-hover:opacity-100 md:group-hover:translate-x-0 group-active:translate-x-2 group-active:scale-110 transition-all ease-in-out duration-200" alt="" />
                    </div>
                </a>
            </div >
        </div>
