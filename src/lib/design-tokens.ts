...
export const testimonials = {
  ...
  headerGap: 12,
  titleWidth: "min(100%, 380px)",
  descriptionWidth: "min(100%, 360px)",
  sectionGap: "clamp(12px, 2vh, 20px)",
  photosHeight: 350,
  photosGap: 24,
  photoActiveWidth: 880,
  photoInactiveWidth: 200,
  framePadding: "clamp(16px, 2.5vw, 24px)",
  quoteWidth: "clamp(80px, 12vw, 180px)",
  quoteHeight: "clamp(64px, 9vw, 140px)",
  contentWidth: "min(100%, 720px)",
  attributionGap: 6,
  panelTransitionMs: 400,
